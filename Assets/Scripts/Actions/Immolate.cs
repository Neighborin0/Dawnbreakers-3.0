...
public class Immolate : Action
{
    ...
    public override IEnumerator ExecuteAction()
    {
        ...
        BattleSystem.Instance.StartCoroutine(CombatTools.PlayVFX(targets.gameObject, "IgniteSmoke", new Color(255, 74, 0), new Color(255, 74, 0), new Vector3(0, -3, 0), Quaternion.identity, 10, 0, false, 8, 0.01f, 0.0001f, "incinerate_cackle_001"));
